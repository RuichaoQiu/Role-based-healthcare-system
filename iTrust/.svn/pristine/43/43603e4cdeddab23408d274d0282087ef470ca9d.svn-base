...
public class DAOFactory {
	...
	public DeathStatsDAO getDeathStatsDAO(){
		return new DeathStatsDAO(this);
	}
	/**
	 * 
	...
	/**
	 * 
	 * @return this DAOFactory's ObstericVisitDAO
	 */
	public ObstericVisitDAO getObstericVisitDAO() {
		return new ObstericVisitDAO(this);
	}
	...
	/**
	 * 
	 * @return this DAOFactory's InitRecordsDAO
	 */
	public InitRecordsDAO getInitRecordsDAO() {
		return new InitRecordsDAO(this);
	}
}
