<div class="panel panel-default">
	...
	<div class="panel-body" id="info-menu">
		<ul class="nav nav-sidebar">
			...
			<li><a href="/iTrust/auth/hcp/causeOfDeath.jsp">View cause-of-death Reports</a>
			...
			<li><a href="/iTrust/auth/hcp-uap/InitRecords.jsp">Initialization Records</a>
		</ul>
	</div>
</div>
...
<div class="panel panel-default">
	...
	<div class="panel-body" id="ov-menu">
		<ul class="nav nav-sidebar">
		   ...
		   <li><a href="/iTrust/auth/hcp-uap/documentObstetrics.jsp">Document Obstetrics Office Visit</a>
		</ul>
	</div>
</div>
...
<div class="panel panel-default">
	...
	<div class="panel-body" id="msg-menu">
		<ul class="nav nav-sidebar">
		    ...
		    <li><a href="/iTrust/auth/hcp/sendImmunizationReminders.jsp">send Immunization Reminders</a>
		</ul>
	</div>
</div>
