...
CREATE TABLE IF NOT EXISTS InitRecords (
	mid  BIGINT UNSIGNED,
	lastName varchar(20) NOT NULL default '',
	firstName varchar(20) NOT NULL default '',
	LMP date NOT NULL default '0000-00-00',
	EDD date NOT NULL default '0000-00-00',
	weeksPreg varchar(40) NOT NULL default '',
	PriorPregnancies VARCHAR(500),
	Notes VARCHAR(500)
) ENGINE=MyISAM;

CREATE TABLE IF NOT EXISTS Obsterics (
	ID int(10) unsigned auto_increment,
	visitDate date default '0000-00-00', 
	daysPreg varchar(20) default '',
	weeksPreg varchar(20) default '',
	weight varchar(20) default '',
	SBloodPressure varchar(20) default '',
	DBloodPressure varchar(20) default '',
	FHR varchar(20) default '',
	FHU varchar(20) default '',
	PatientID BIGINT unsigned default '0',
	PRIMARY KEY  (ID)
) ENGINE=MyISAM;
...
CREATE TABLE IF NOT EXISTS messageFilters (
	...
	contains varchar(512) NOT NULL default '',
	notContains varchar(512) NOT NULL default '',
