...
public class DiagnosisStatisticsBean {
	...
	long stateStats;
	/** The diagnosis count for the nation */
	long nationStats;
	 ...
	 * @param nationStats The count of diagnoses for the nation
	 * @param startDate The beginning of the data's time period
	 * @param endDate The end of the data's time period
	 */
	public DiagnosisStatisticsBean(String zipCode, long zipStats,
			long regionStats, long stateStats, long nationStats,
	 ...
	 * @param stateStats The count of state-wide diagnoses to be stored
	 */
	public void setStateStats(long stateStats) {
		this.stateStats = stateStats;
	}
	/**
	 * Getter for Nation count
	 * @return The count of diagnoses for the nation
	 */
	public long getNationStats() {
		return nationStats;
	}
	/**
	 * Setter for Nation count
	 * @param NationStats The count of national diagnoses to be stored
	 */
	public void setNationStats(long nationStats) {
		this.nationStats = nationStats;
	}
