...
<%
	...
	<table class="fTable" align="center">
		<tr>
        	<th colspan="16" style="text-align: center;">Obstetric Office Visit Record</th>
	    </tr>
		<tr>
			...
			<td align="center" colspan="2">Week(s) Pregnant:  
				<input name="PregWeek"
				value="<%= StringEscapeUtils.escapeHtml("" + (ovbean.getWeeksPreg())) %>" style="width: 50px" type="text"
				maxlength="10" 
				readOnly="true"/>
			</td>
			<td align="center" colspan="2">Day(s) Pregnant:  
				<input name="PregDay"
			...
			<td align="center" colspan="2">Fundamental Height of Uterus:  
				<input name="FHU"
