...
public enum TransactionType {
	/**GENERIC_CODE*/
	GENERIC_CODE(0,"Generic Code", "This should only be used internally", false),
	/**LOGIN_FAILURE*/
    ...
    /**REQUEST_BIOSURVEILLANCE*/
    REQUEST_BIOSURVEILLANCE(1400, "Request any sort of biosurveillance", "requested a biosurveillance", false),
    ...
    /**SEND_APPOINTEMNT_REMINDER_MESSAGE*/
    SEND_APPOINTMENT_REMINDER_MESSAGE(4100,"Send Reminder Message for Appointments", "sent reminder for appointments", false),
    /**NOTIFICATIONS_VIEW*/
	...
	/**HCP_VIEW_BASIC_HEALTH_METRICS*/
	HCP_VIEW_INIT_RECORD(6300, "HCP View Init Records", "viewed init records", true),
	HCP_CREATE_INIT_RECORD(6301, "HCP Create Init Records", "created an init record", true),
	OBSTETRIC_OFFICE_VISIT_CREATE(6400, "Create Obstetric Office Visits", "created obstetric office visit", true),
	OBSTETRIC_OFFICE_VISIT_VIEW(6401, "View Obstetric Office Visits", "viewed obstetric office visit", true),
	OBSTETRIC_OFFICE_VISIT_EDIT(6402, "Edit Obstetric Office Visits", "edited obstetric office visit", true);
