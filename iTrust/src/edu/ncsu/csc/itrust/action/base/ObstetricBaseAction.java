 ...
 */
abstract public class ObstetricBaseAction extends PatientBaseAction {
	 ...
	 */
	public ObstetricBaseAction(DAOFactory factory, String pidString, String ovIDString)
			throws ITrustException {
		super(factory, pidString);
		this.ovDAO = factory.getObstericVisitDAO();
	 ...
	 * @throws ITrustException
	 */
	public ObstetricBaseAction(DAOFactory factory, String pidString)
			throws ITrustException {
		super(factory, pidString);
		this.ovDAO = factory.getObstericVisitDAO();
