...
public class TestDataGenerator {
	...
	public void hcp111() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/hcp111.sql");
	}
	...
	public void patient88() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patient88.sql");
	}
	...
	public void hcp_diagnosis_data2() throws FileNotFoundException, IOException, SQLException {
		new DBBuilder(factory).executeSQLFile(DIR + "/hcp_diagnosis_data2.sql");
	}
	...
	public void uc64testdata1() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/uc64testdata1.sql");
	}
	/*
...
//		System.out.println("Operation completed.");
	...
	public void uc63testdata1() throws FileNotFoundException, SQLException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/uc63testdata1.sql");
	}
